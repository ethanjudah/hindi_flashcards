...
def next_card():
    ...
    canvas.itemconfig(card_transliteration,
                      text=current_card["Transliteration"],  # Ensure this matches your CSV column name
                      fill="black")
    # Front card image
...
def flip_card():
    ...
    # Optionally, clear transliteration or show something else
    canvas.itemconfig(card_transliteration, text="", fill="white")
...
card_word = canvas.create_text(400, 263, text="",
                               font=("Ariel", 60, "bold"))
# NEW: Create a text item for transliteration, placed somewhere below the word
card_transliteration = canvas.create_text(400, 340, text="",
